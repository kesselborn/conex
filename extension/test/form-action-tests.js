...
describe(component, function () {
  ...
  it('should react on collapse / un-collapse actions', async function () {
    ...
    expect(firstFakeContainerElement.classList.contains(Selectors.collapsedContainer), 'container should contain collapsed class as a default').to.be.true;
    toggleCollapseLabel.click();
    expect(firstFakeContainerElement.classList.contains(Selectors.collapsedContainer), 'container should not contain collapsed class after click').to.be.false;
    toggleCollapseLabel.click();
    expect(firstFakeContainerElement.classList.contains(Selectors.collapsedContainer), 'container should contain collapsed class after two click').to.be.true;
  });
});

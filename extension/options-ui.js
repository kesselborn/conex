...
import { debug, Level, loadSettings, persistLogLevel } from './logger.js';
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  function newSelectionBox(component) {
    return $e('li', {}, [
  ...
  selectorContainer.addEventListener('click', (e) => {
    ...
    const selectedComponent = e.target.parentNode.name;
    debug(component, `log-level adjustment: component ${selectedComponent}=${value}`);
    persistLogLevel(selectedComponent, value);
  });
});

...
export function tabElement(container, tab) {
  ...
  if (tab.favIconUrl === undefined || tab.favIconUrl === null) {
    tab.favIconUrl = './question-mark.svg';
    brokenImage = true;
  }

  return $e('li', { tabindex: 0, id: tabId2HtmlId(tab.id), class: `container-tab container-color-${container.color}` }, [
    ...
    $e('label', { for: tabId2HtmlOpenTabId(tab.id), class: 'tab-center' }, [
      $e('div', { class: 'images' }, [
        $e('img', { class: 'favicon', src: tab.favIconUrl, broken: brokenImage }),
        $e('img', { class: 'thumbnail', src: tab.favIconUrl, broken: brokenImage }),
      ]),
